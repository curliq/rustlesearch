...
export default options => {
  ...
  if (!supportedLevels.includes(level)) throw new Error(`${level} not supported by logger`)

  if (!Array.isArray(ignore)) throw new Error(`ignore option must be array. Got: ${ignore}`)
